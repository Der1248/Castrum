...
local cannon3 = {}
cannon3.get_formspec = function(player, pos)
	if player == nil then
        return
    end
...
minetest.register_node("castrum:cannon3",{
	tiles  = {"default_diamond_block.png"},
	description = "Configurate Cannon 3",
    --groups = {snappy=1,choppy=2,oddly_breakable_by_hand=2,flammable=3},
    on_punch = function(pos, node, player, pointed_thing)
        minetest.show_formspec(player:get_player_name(), "cannon3" , cannon3.get_formspec(player))
    end,
})
