...
minetest.register_on_player_receive_fields(function(player, formname, fields)
	...
	if formname == "tower3" then
        for k, v in pairs(fields) do
            if v == "del" then
                minetest.place_schematic({x=-74, y=9, z=30}, minetest.get_modpath("castrum").."/schematics/Tower3/Tower3_0.mts","0")
            ...
            elseif v == "Upgrade" or v == "Build" then
                ...
                if (tonumber(level)) < 24 and upgrade or buildings_costs == false then
                    minetest.place_schematic({x=-74, y=9, z=30}, minetest.get_modpath("castrum").."/schematics/Tower3/Tower3_"..(tonumber(level)+1)..".mts","0")
                    file = io.open(minetest.get_worldpath().."/SAVE/Tower3.txt", "w")
