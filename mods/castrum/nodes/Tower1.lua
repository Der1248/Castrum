...
minetest.register_on_player_receive_fields(function(player, formname, fields)
	...
	if formname == "tower1" then
        for k, v in pairs(fields) do
            if v == "del" then
                minetest.place_schematic({x=-13, y=9, z=-31}, minetest.get_modpath("castrum").."/schematics/Tower1/Tower1_0.mts","0")
            ...
            elseif v == "Upgrade" or v == "Build" then
                ...
                if (tonumber(level)) < 24 and upgrade or buildings_costs == false then
					minetest.place_schematic({x=-13, y=9, z=-31}, minetest.get_modpath("castrum").."/schematics/Tower1/Tower1_"..(tonumber(level)+1)..".mts","0")
                    file = io.open(minetest.get_worldpath().."/SAVE/Tower1.txt", "w")
